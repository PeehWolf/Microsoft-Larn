...
foreach (string name in studentNames)
{
    ...
    */
    ...
    studentExtraGraded = (decimal)(sumExtraCreditScores) / gradedExtraCreditAssignments;

    overallStudentGrade = (((decimal)(sumExtraCreditScores) / 10) + (decimal)(sumExamScores)) / examAssignments;
    ...
    Console.WriteLine($"{currentStudent}\t\t{studentExamScore}\t\t{overallStudentGrade}\t{currentStudentLetterGrade}\t{studentExamScore}({(((decimal)(sumExtraCreditScores) / 10 / examAssignments))} pts) ");
}
